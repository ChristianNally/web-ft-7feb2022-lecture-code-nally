...
rlp.questionAsync('What do you think of Node.js? ')
  ...
  .then((answer) => {
    answers.push(answer);
    return rlp.questionAsync('What\'s your ACTUAL favourite activity? ');
  })
  .then((answer) => {
    answers.push(answer);
  ...
  .then((answer) => {
    ...
    const actualActivity = answers[3];
    const music = answers[4];
    const meal = answers[5];
    const food = answers[6];
